        ...
        <div className="mx-auto min-h-screen max-w-[794px] print:max-w-none print:px-0 print:shadow-none">
          <div className="screen-sheet bg-white px-6 py-10 shadow-sm print:px-12 print:py-8 print:shadow-none md:px-10 md:py-12">
            ...
            <ProjectSection title="설정 관리 페이지 개발">
              ...
              <ProblemBlock>
                <p className="font-medium text-zinc-900 print:text-black">1. 복수 설정 도메인의 상태·로직 혼재 위험</p>
                <p className="mt-2">
                  전역 설정, 센터별 설정, 예외일, 변경 이력이 각각 다른 API와 UI 패턴을
                  가져 하나의 컴포넌트에서 처리할 경우 상태와 로직이 쉽게 뒤섞일 수
                  있었습니다.
                </p>
                <p className="mt-4 font-medium text-zinc-900 print:text-black">
              ...
              <SolutionBlock>
                ...
                <p className="mt-6 font-medium text-zinc-900 print:text-black">
                ...
                <p className="mt-2">
                  서버 상태(TanStack Query)와 별도로 로컬 편집 상태( status , centerStatus
                  )를 두어, 저장 전까지는 변경이 서버에 반영되지 않도록 설계했습니다.
                </p>
                <p className="mt-2">
            ...
            <section className="break-inside-avoid border-t border-zinc-200 py-8 print:border-zinc-300 print:py-6">
              ...
              <ul className="mt-4 list-disc space-y-3 pl-5 text-[15px] leading-7 text-zinc-800 print:text-zinc-900">
                <li>
